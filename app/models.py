...
class Tasks(db.Model):
    ...
    id_folder = db.Column(db.Integer, db.ForeignKey('folders.id'))
...
class Users_Data(db.Model):
    ...
    address = db.Column(db.Text, nullable=True)#адресс проживания 
    bankAccount = db.Column(db.Text, nullable=True)# что это ?
